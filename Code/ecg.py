class ECG:
    ...
    def __init__(self):
        ...
        self.input_file = input("Please enter the input filename(s): ")
    ...
    def write_file(self):
        ...
        output_file = self.input_file.split(".")[1] + "_out"
        write_to_file(output_file, self.inst_hr, self.avg_hr[0], self.condition)
